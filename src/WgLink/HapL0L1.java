...
public class HapL0L1 {
    ...
    DivideConquer dc_param;
    double min_cov = 20;
    double average_num_haps;
    
//	public HapL0L1( DivideConquer dc, String vef) throws IOException, InterruptedException {
//		
//		int num_merge_regions = dc.region_start.length;
//		Vector<Integer  > posStartVec = new Vector<Integer  >();
//		Vector<Integer  > posEndVec = new Vector<Integer  >();
//		for (int i=0;i< num_merge_regions;i++) {
//			posStartVec.add(dc.region_start[i]) ;
//			posEndVec.add(dc.region_end[i]) ;
//		}
//		Vector<Integer  > new_posStartVec = new Vector<Integer  >();
//		Vector<Integer  > new_posEndVec = new Vector<Integer  >();
//		while (num_merge_regions>1 ) {
//			int start_index =0;
//			int end_index =1;
//			while (end_index <   posEndVec.size()   ) {
//				
//				HapConfig hc1 = new HapConfig (dc.out_dir+"/intermediate/"+ Integer.toString(posStartVec.get(start_index))+"_"
//						+ Integer.toString(posEndVec.get(start_index))+"/"+ dc.project_name+"_inter.freq");
//				HapConfig hc2 = new HapConfig (dc.out_dir+"/intermediate/"+ Integer.toString(posStartVec.get(end_index))+"_"
//						+ Integer.toString(posEndVec.get(end_index))+"/"+ dc.project_name+"_inter.freq");
//				int tiling_index =-1;
//				for (int i=0;i< dc.tiling_region_start.length;i++) {
//					if ( (dc.tiling_region_start[i] <=  posEndVec.get(start_index) )  && 
//						(dc.tiling_region_end[i] >=  posStartVec.get(end_index) ) ) {
//						tiling_index= i;
//					}
//				}
...
//				
//				HapConfig hc12 =   hc2.merge2regions(hc1, hc2, hc_paste, dc.mismatch_tolerance);
//				while ( (hc12.Haps.length< dc.Max_L0L1_Regional_Haps)  &&  (end_index<(posStartVec.size()-1) ) )   {
//					end_index++;
//					hc2 = new HapConfig (dc.out_dir+"/intermediate/"+ Integer.toString(posStartVec.get(end_index))+"_"
//							+ Integer.toString(posEndVec.get(end_index))+"/"+ dc.project_name+"_inter.freq");
//					
//					tiling_index =-1;
//					for (int i=0;i< dc.tiling_region_start.length;i++) {
//						if ( (dc.tiling_region_start[i] <=  posEndVec.get(end_index-1) )  && 
//							(dc.tiling_region_end[i] >=  posStartVec.get(end_index) ) ) {
//							tiling_index= i;
//						}
//					}
...
//							+  Integer.toString(dc.tiling_region_end[tiling_index])+"/"+ dc.project_name+"_inter.freq");
//					
//					hc12 =   hc2.merge2regions(hc12, hc2, hc_paste, dc.mismatch_tolerance);
//				}
//				
//				new File(dc.out_dir+"/intermediate/"+ Integer.toString(posStartVec.get(start_index))+"_"
//						+ Integer.toString(posEndVec.get(end_index))).mkdir();
//				hc12.write2file(hc12, dc.out_dir+"/intermediate/"+ Integer.toString(posStartVec.get(start_index))+"_"
//						+ Integer.toString(posEndVec.get(end_index))+"/"+ dc.project_name+".potential.haps");
//				System.out.println(dc.out_dir+"/intermediate/"+ Integer.toString(posStartVec.get(start_index))+"_"
//						+ Integer.toString(posEndVec.get(end_index))+"/"+ dc.project_name+".potential.haps" );
//				// L0L1
//				this.calcualte_LD_matrix(vef, dc.out_dir+"/intermediate/"+ Integer.toString(posStartVec.get(start_index))+"_"
//						+ Integer.toString(posEndVec.get(end_index))+"/"+ dc.project_name+".potential.haps" , dc);
//				
//				this.scriptR( dc.out_dir+"/intermediate/"+ Integer.toString(posStartVec.get(start_index))+"_"
//						+ Integer.toString(posEndVec.get(end_index))+"/"+ dc.project_name+".R", dc.out_dir+"/intermediate/"+ 
//								Integer.toString(posStartVec.get(start_index))+"_"
//								+ Integer.toString(posEndVec.get(end_index))+"/"+ dc.project_name+".potential.haps.regression.in", 
//								dc.out_dir+"/intermediate/"+ Integer.toString(posStartVec.get(start_index))+"_"
//								+ Integer.toString(posEndVec.get(end_index))+"/"+ dc.project_name+".potential.haps.regression.out"  );
//				
//				this.run_R(dc.out_dir+"/intermediate/"+ Integer.toString(posStartVec.get(start_index))+"_"
//						+ Integer.toString(posEndVec.get(end_index))+"/"+ dc.project_name+".R");
//				
//				this.generate_inter_freq(dc.out_dir+"/intermediate/"+ Integer.toString(posStartVec.get(start_index))+"_"
//						+ Integer.toString(posEndVec.get(end_index))+"/"+ dc.project_name+".potential.haps", 
//						dc.out_dir+"/intermediate/"+ Integer.toString(posStartVec.get(start_index))+"_"
//								+ Integer.toString(posEndVec.get(end_index))+"/"+ dc.project_name+".potential.haps.regression.out" ,
//								dc.out_dir+"/intermediate/"+ Integer.toString(posStartVec.get(start_index))+"_"
//								+ Integer.toString(posEndVec.get(end_index))+"/"+ dc.project_name+"_inter.freq" );
//				
//				new_posStartVec.add(posStartVec.get( start_index) ) ;
//				new_posEndVec.add(posEndVec.get( end_index)) ;
...
//			posStartVec.clear();
//			posEndVec.clear();
//			for (int i=0;i< new_posStartVec.size();i++) {
//				posStartVec.add(new_posStartVec.get(i));
//				posEndVec.add(new_posEndVec.get(i));
//			}
//			new_posStartVec.clear();
//			new_posEndVec.clear();
//			num_merge_regions= posStartVec.size();
//		}
//	}
//	
	

	public HapL0L1( DivideConquer dc, String vef) 
		...
		for (int i=0;i< dc.region_start.length; i++) {
			...
			total_haps= total_haps+ (double) hc_tmp.Haps.length;//            	else {
...
//                System.out.println(line);
            ...
            CMDProcess.waitFor();
//            System.out.println("L0L1 Finished.");
            br.close();
	}
...
//            		System.out.println( "*\t" + this.l0l1_local_matrix[i][j]);
	...
	public void calcualte_LD_matrix(String vef_file, String hap_fil, DivideConquer dc) 
			throws IOException, InterruptedException {
		this.dc_param = dc;
